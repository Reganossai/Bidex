  ...
  return (
    <div className='ong-seed'>
        <div id="ong-seed-sub" className='ongoing-seed-header mb-1'>
            <h1 className='ongoing-header'>Ongoing Seeds</h1>
        ...
        <div id="ong-seed-sub" className="mt-6 seed-table">
            <div className="seed-table-content p-3 px-2 flex items-center justify-between">
                <div className='flex justify-center items-center' >
                 <div className="country-icon mx-2"></div>
                ...
                <div><img src={TransactionImg} alt="" /></div>
                <h2 className='seed-status seed-status-canceled font-extrabold'>cancelled</h2>
        ...
        <div id="ong-seed-sub" className=" seed-table">
            <div className="seed-table-content p-3 px-2 flex items-center justify-between">
                ...
                <div><img src={TransactionImg} alt="" /></div>
                <h2 className='seed-status seed-status-active font-extrabold'>active</h2>
                <h2 className="font-bold text-black seed-value">$1000</h2>
            </div>
        </div>
        ...
        <div id="ong-seed-sub" className=" seed-table">
            <div className="seed-table-content p-3 px-2 flex items-center justify-between">
                ...
                <div><img src={TransactionImg} alt="" /></div>
                <h2 className='seed-status seed-status-completed font-extrabold'>completed</h2>
                <h2 className="font-bold text-black seed-value">$1000</h2>
            </div>
        </div>
